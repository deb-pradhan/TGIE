...
export const work = {
  ...
  examples: [
    ...
    { tag: "Startup MVP · A + B", title: "Field-deployable environmental sensor", note: "PCB, firmware, and a ruggedized PA-CF enclosure with weatherproof connector cutouts. Avoids injection-mold tooling costs at MVP volumes." },
    ...
    { tag: "Collector · Pillar B", title: "Museum-grade scale replica", note: "Multi-material printing, with composite textures and metallic finishes, for an exact-scale desktop centerpiece." },
